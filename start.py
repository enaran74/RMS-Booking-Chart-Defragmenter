...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p SADE,QROC,TCRA    # Analyze specific properties
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p ALL               # Analyze all properties
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p SADE              # Analyze single property
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -e -p ALL            # Analyze all properties with email notifications
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -e -p SADE,QROC      # Analyze specific properties with email notifications
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -t -p ALL            # Analyze all properties using training database
  python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -t -e -p SADE,QROC   # Analyze specific properties with emails using training database (emails sent to operations@discoveryparks.com.au)
...
Note: All RMS credentials are MANDATORY. Replace the example credentials with your actual RMS credentials.
    ...
    def error_handler(message):
        ...
        print("  python3 start.py --agent-id 224 --agent-password \"********\" --client-id 2998 --client-password \"********\" -p SADE,QROC,TCRA    # Analyze specific properties")
        print("  python3 start.py --agent-id 224 --agent-password \"********\" --client-id 2998 --client-password \"********\" -p ALL               # Analyze all properties")
        print("  python3 start.py --agent-id 224 --agent-password \"********\" --client-id 2998 --client-password \"********\" -p SADE              # Analyze single property")
        print("  python3 start.py --agent-id 224 --agent-password \"********\" --client-id 2998 --client-password \"********\" -e -p ALL            # Analyze all properties with email notifications")
        print("  python3 start.py --agent-id 224 --agent-password \"********\" --client-id 2998 --client-password \"********\" -t -p ALL            # Analyze all properties using training database")
        print()
        print("🌐 LINUX SERVER DEPLOYMENT (using environment variables):")
        print("  export AGENT_ID=224")
        print("  export AGENT_PASSWORD=\"********\"")
        print("  export CLIENT_ID=2998")
