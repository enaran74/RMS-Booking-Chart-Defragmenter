...
| `SENDER_EMAIL` | No | admin@quickswitch.com.au | Sender email address |
...
python3 start.py --agent-id 224 --agent-password "password" --client-id 2998 --client-password "password" -p ALL

# Using environment variables
export AGENT_ID=224
export AGENT_PASSWORD="password"
export CLIENT_ID=2998
