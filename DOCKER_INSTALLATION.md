...
TEST_RECIPIENT=tim@quickswitch.com.au
...
| `SENDER_EMAIL` | ❌ | `admin@quickswitch.com.au` | Email sender address |
| `SENDER_DISPLAY_NAME` | ❌ | `DHP Systems` | Email sender display name |
| `APP_PASSWORD` | ❌ | - | Gmail app password |
| `TEST_RECIPIENT` | ❌ | `tim@quickswitch.com.au` | Test email recipient |
