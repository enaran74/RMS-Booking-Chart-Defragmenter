...
```bash
# Analyze specific properties
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p SADE,QROC,TCRA

# Analyze single property
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p SADE

# Analyze all properties
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -p ALL
```

#### Analysis with Email Notifications
```bash
# Analyze all properties with email notifications
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -e -p ALL
...
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -t -p ALL
...
python3 start.py --agent-id 224 --agent-password "********" --client-id 2998 --client-password "********" -t -e -p ALL
