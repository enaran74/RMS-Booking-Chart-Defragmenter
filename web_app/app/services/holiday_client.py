...
from app.services.school_holiday_client import SchoolHolidayClient
...
class HolidayClient:
    ...
    def __init__(self, cache_ttl: int = 86400, timeout: int = 30):
        ...
        # Initialize school holiday client with correct path for containerized environment
        self.school_holiday_client = SchoolHolidayClient("/app/school_holidays.json")
